...
interface class AppTypography extends ThemeExtension<AppTypography> {
  ...
  ThemeExtension<AppTypography> copyWith({
    ...
    TextStyle? subtitle4Light,

    TextStyle? body1Light,
    TextStyle? body2Light,
    TextStyle? captionLight,
    TextStyle? overlineLight,
    TextStyle? overlineSmallLight,
    TextStyle? overlineLargeLight,
    ...
    TextStyle? h5Regular,
    TextStyle? h6Regular,
    TextStyle? subtitle1Regular,
    TextStyle? subtitle2Regular,
    TextStyle? subtitle3Regular,
    TextStyle? subtitle4Regular,

    TextStyle? body1Regular,
    TextStyle? body2Regular,
    TextStyle? captionRegular,
    TextStyle? overlineRegular,
    TextStyle? overlineSmallRegular,
    TextStyle? overlineLargeRegular,
    ...
    TextStyle? subtitle3Medium,
    TextStyle? subtitle4Medium,

    TextStyle? body1Medium,
    TextStyle? body2Medium,
    TextStyle? captionMedium,
    TextStyle? overlineMedium,
    TextStyle? overlineSmallMedium,
    TextStyle? overlineLargeMedium,
    ...
    TextStyle? subtitle3SemiBold,
    TextStyle? subtitle4SemiBold,
    TextStyle? subtitle1Bold,
    TextStyle? subtitle2Bold,
    TextStyle? subtitle3Bold,
    TextStyle? subtitle4Bold,

    TextStyle? body1SemiBold,
    TextStyle? body2SemiBold,
    TextStyle? captionSemiBold,
    TextStyle? overlineSemiBold,
    TextStyle? overlineSmallSemiBold,
    TextStyle? overlineLargeSemiBold,
